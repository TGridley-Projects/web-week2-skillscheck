...
function oddChecker(num){
	if( num % 2 === 1 ){ return 'the number is odd'
...
//Code Here
const me = {firstName: 'Trevor', state: 'California', age: 50, greeter: function(){ return `Hello! My name is ${me.firstName} and I live in ${me.state}`}};
...
myNumbers.forEach((elem , ind) => myNumbersIndex.push(ind))
...
const enemies = people.filter(function(obj) {
